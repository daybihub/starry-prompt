  ...
  return (
    <div className="relative">
      <textarea
        ...
        className="custom-scrollbar w-full h-40 bg-black/90 dark:bg-black/90 light:bg-white/90 backdrop-blur-sm rounded-xl p-4 pr-24 resize-none border border-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all focus:border-[#ff00ea] focus:shadow-[0_0_30px_-5px_#ff00ea] duration-300"
